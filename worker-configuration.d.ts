/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66b4ba72436a85faaa65086a3cbbf8a6)
...
interface __BaseEnv_Env {
	...
	AI: Ai;
	ASSETS: Fetcher;
	BUCKET_PUBLIC_URL: "https://3m-platform-photos.r2.dev";
	CLOUDFLARE_ACCOUNT_ID: "YOUR_CLOUDFLARE_ACCOUNT_ID";
	AI_GATEWAY_ACCOUNT_ID: "YOUR_AI_GATEWAY_ACCOUNT_ID";
	AI_GATEWAY_NAME: "YOUR_AI_GATEWAY_NAME";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUCKET_PUBLIC_URL" | "CLOUDFLARE_ACCOUNT_ID" | "AI_GATEWAY_ACCOUNT_ID" | "AI_GATEWAY_NAME">> {}
}
